  ...
  <div class="page_body">
    <div class="reg_box">
      <p class="reg_box_h" >ENTRY TO HELL!</p>
        ...
        <a href="index.php" class="login_link"><p>Is your Soul already Tainted? Login here!</p></a>   
        </div>
    </div>
   </div>
   ...
   <audio autoplay loop volume="0.0">
    <source src="audio/Hell.mp3" type="audio/mp3">
  </audio>
  <audio class="burning_hover" preload="auto">
    <source src="audio/button_burning.mp3" type="audio/mp3">
  </audio>
</body>
</html>
<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username)){
      ...
      try{
       ...
       // exit(); // It's good practice to exit after a header("Location") to ensure no further code execution
       echo "<script>
       setTimeout(function(){
